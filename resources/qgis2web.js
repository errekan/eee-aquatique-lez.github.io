...
map.getView().fit([384338.407892, 5381622.759566, 479272.980641, 5436045.685544], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Espèces exotiques envahissantes dulçaquicoles sur le bassin du Lez</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (19 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '© ERREKAN - 03/2025';
            }
